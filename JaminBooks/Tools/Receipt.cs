...
namespace JaminBooks.Tools
{
    ...
    {
        public static void SendReceipt(Order order, decimal OrderTotal)
        {
			                ...
			                <td colspan=""2"" style=""padding:30px 0;"">
			                  ...
			                  <div>
				                ...
				                <div style=""margin: 20px 0px"">
					                <span style=""font-size:30px;font-weight:bold;margin-right:20px"">Order Total:</span> <span style=""font-size:22px;color:#1d2227;font-weight:400;"">$" + OrderTotal.ToString("0.00") +@"</span>
				                </div>
				                <hr/>
				                <div>
